...
export function calculateChange(billTotal: number, cashReceived: number): ChangeBreakdown[] {
...
// calculate the change due
  ...
  for (const denomination of DENOMINATIONS) {
    if (remainingCents >= denomination.value) { // Check if the remaining change can be covered by this denomination
